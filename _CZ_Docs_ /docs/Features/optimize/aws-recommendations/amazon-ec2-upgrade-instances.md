---
title: Amazon EC2 Upgrade Instances
category: features
createdAt: '2025-10-17T00:00:00.000Z'
hidden: false
slug: Amazon_EC2_Upgrade_Instances
...
This Recommendation identifies EC2 instances that should be upgraded to newer generation instances for cost optimization.

# What it does

* Identifies EC2 instances that are candidates for upgrading to newer generations
